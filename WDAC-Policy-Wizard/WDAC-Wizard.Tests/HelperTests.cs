    ...
    public class HelperTests
    {
        ...
        public void EKUValueToTLVEncoding_CommonEKUs_ReturnsValidEncodings()
        {
            ...
            var ekus = new Dictionary<string, string>
            {
                ...
                { "1.3.6.1.4.1.311.61.4.1", "010A2B0601040182373D0401" }, // ELAM
                { "1.3.6.1.4.1.311.61.5.1", "010A2B0601040182373D0501" }, // HAL EXT
                {"1.3.6.1.4.1.311.10.3.21", "010A2B0601040182370A0315" }, // RT EXT
